...
//    {
//        public override bool ShouldResolveReference(RefInfo refInfo) => state.HasEnteredNonNestedReference || !refInfo.IsNestedInThisDocument || refInfo.IsFalseAbsoluteRef;
